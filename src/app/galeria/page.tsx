      ...
      <section className="py-section-gap px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto w-full">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-gutter">
          ...
          <div className="md:col-span-4 bg-surface border border-outline-variant rounded-xl overflow-hidden shadow-sm group">
            <div className="relative h-48 w-full flex">
              <div className="w-1/2 relative bg-surface-container-high">
                <img alt="Coche dañado antes de la reparación" className="absolute inset-0 w-full h-full object-cover grayscale" src="img17a.webp" />
              ...
              <div className="w-1/2 relative bg-surface">
                <img alt="Coche reparado brillante" className="absolute inset-0 w-full h-full object-cover" src="img17d.webp" />
            ...
            <div className="p-6">
              <h4 className="font-headline-md text-headline-md text-primary mb-2 text-xl">Cambio de Cristal Frontal</h4>
              <p className="font-body-md text-body-md text-on-surface-variant text-sm">Instalación de cristal frontal en vehiculo de transporte, reparado en domicilio</p>
            </div>
          </div>
          ...
          <div className="md:col-span-4 bg-surface border border-outline-variant rounded-xl overflow-hidden shadow-sm group">
            <div className="relative h-48 w-full flex">
              <div className="w-1/2 relative">
                <img alt="Detalle de rasguño antes" className="absolute inset-0 w-full h-full object-cover grayscale" src="img11a.webp" />
              </div>
              <div className="w-1/2 relative">
                <img alt="Detalle reparado brillante" className="absolute inset-0 w-full h-full object-cover" src="img11.webp" />
              </div>
            </div>
            <div className="p-6">
              <h4 className="font-headline-md text-headline-md text-primary mb-2 text-xl">Cambio de cristal frontal en Maquinaria pesada</h4>
              <p className="font-body-md text-body-md text-on-surface-variant text-sm">Instalación de cristal frontal en maquinaria pesada reparado en faena.</p>
            </div>
          </div>
          ...
          <div className="md:col-span-4 bg-surface border border-outline-variant rounded-xl overflow-hidden shadow-sm group">
            <div className="relative h-48 w-full flex">
              <div className="w-1/2 relative">
                <img alt="Parabrisas roto" className="absolute inset-0 w-full h-full object-cover grayscale" src="img16a.webp" />
              </div>
              <div className="w-1/2 relative">
                <img alt="Parabrisas nuevo" className="absolute inset-0 w-full h-full object-cover" src="img16d.webp" />
              </div>
            </div>
            <div className="p-6">
              <h4 className="font-headline-md text-headline-md text-primary mb-2 text-xl">Cambio de Cristales</h4>
              <p className="font-body-md text-body-md text-on-surface-variant text-sm">Instalación certificada de parabrisas de todo tipo de vehículo.</p>
            </div>
          </div>
        ...
        <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-tertiary-container p-6 rounded-lg border border-outline-variant/20">
              ...
              <p className="font-body-md text-body-md text-on-tertiary-container mb-6 italic">"Rápida atención para el cambio de parabrisas. Me explicaron el proceso post cambio y me sentí seguro dejando mi camioneta en sus manos."</p>
